> 🛑 This code has vulnerabilities on purpose for education and testing purposes, use at your own risk. This is a clone of [NodeGoat](https://github.com/OWASP/NodeGoat) without the comments suggesting the fix.
